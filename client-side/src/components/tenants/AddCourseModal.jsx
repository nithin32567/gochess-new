        ...
        >
          <div className="w-1/2 flex flex-col gap-4">
            ...
            <div>
              ...
              {/* store the category id in the form data because the mongodb data storing the reference of the categories subcategories ,levels ,languages */}
              <select
                id="category"
                name="category"
          ...
          {/* create subcategories if wanted button */}
          <div className="w-1/2 flex flex-col gap-4">
            <div>
              <label
                htmlFor="language"
