...
const LessonAddForm = ({ moduleId, module }) => {
  ...
  const handleDrop = async (dropIndex, e) => {
    ...
    try {
      ...
      const response = await dispatch(updateLessonOrders(reorderedLessons));
