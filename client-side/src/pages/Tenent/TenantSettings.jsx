...
import { FaUser, FaLock, FaBell, FaSave, FaCog } from "react-icons/fa";
      ...
      <div className="settings-grid">
        <div className="input-group">
          ...
          <input
            ...
            onChange={(e) =>
              handleInputChange("security", "currentPassword", e.target.value)
            }
          />
        </div>
        <div className="input-group">
        ...
        <div className="settings-group">
          ...
          <div className="input-group">
            ...
            <input
              ...
              onChange={(e) =>
                handleInputChange("zoom", "apiKeyId", e.target.value)
              }
          ...
          <div className="input-group">
            ...
            <input
              ...
              onChange={(e) =>
                handleInputChange("zoom", "apiKeySecret", e.target.value)
              }
          ...
          >
            ...
            <button
              ...
              style={{
                ...
                border: "none",
                background:
                  activeTab === "security" ? "#f0f0ff" : "transparent",
            ...
            <button
              ...
              style={{
                ...
                border: "none",
                background:
                  activeTab === "notifications" ? "#f0f0ff" : "transparent",
