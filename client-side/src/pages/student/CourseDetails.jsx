...
const CourseDetails = () => {
  ...
  const fetchSingleProduct = async () => {
    ...
    const response = await axios.get(
      `${import.meta.env.VITE_API_URL}/courses/get-single-course/${id}`,
      {
  ...
  const fetchTheModulesAssociatedWithTheCourse = async () => {
    const response = await axios.get(
      `${
        import.meta.env.VITE_API_URL
      }/courses/get-modules-associated-with-the-course/${id}`,
      {
        withCredentials: true,
      }
    );
