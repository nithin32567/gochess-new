...
function GeneratePassword() {
 ...
 console.log(token, "token in the generate password page");
 ...
 const resendMail = async () => {
  ...
  console.log(res, "res in the resend mail page");
 };
         ...
         <div className="col-xl-6 col-lg-9 col-md-8">
          <div className="login-container-wrap">
           ...
           <div className="welcometext">
            ...
            <p>Set Your Password &amp; Log in to access your account &amp; explore more.</p>
           </div>
           ...
           <form onSubmit={handleSubmit}>
            ...
            <button type="submit" className="login-btn">
             Set <i className="fa-solid fa-arrow-right" />
            </button>
