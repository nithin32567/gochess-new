     ...
     <div className="row">
      <div className="col-xl-4 col-lg-4 col-md-6 col-sm-6">
       <button className="courseitem">
        <span>
         <img width={200} height={200} src="/img/courseicon.png" alt="Course" />
        </span>
        <h5>1:1 Course</h5>
        <p>
      ...
      <div className="col-xl-4 col-lg-4 col-md-6 col-sm-6">
       <button className="courseitem">
        <span>
         <img width={200} height={200} src="/img/groupcourseicon.png" alt="Group Course" />
        </span>
        <h5>Group Course</h5>
        <p>Add multiple learners, content and sessions to a single cohort.</p>
       </button>
      </div>
      <div className="col-xl-4 col-lg-4">
       <button className="courseitem">
        <span>
         <img width={200} height={200} src="/img/recordedcourseicon.png" alt="Recorded Course" />
        </span>
    ...
    <div className="container-fluid">
     <div className="row">
      <div className="col-xl-4">
       <div>
        <span>
         <img width={200} height={200} src="/img/explore-image.png" alt="Explore Journey" />
        </span>
        <h3>
         Explore Your <br />
         Learning Journey
      ...
      <div className="col-xl-8">
       <div className="row">
        <div className="col-xl-8 col-lg-8 col-md-8 col-sm-8">
         <p>
          Discover the perfect course for your needs – personalized, <br />
        ...
        <div className="row">
         ...
         <div className="col-lg-6 col-md-6 col-sm-6">
          <button className="learners-itemdiv instructorsbg">
           <div>
            <span>
             <img src="/img/instructors-icon.png" alt="Instructors" />
            </span>
            <h5>Instructors</h5>
